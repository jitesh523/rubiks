...
class HybridColorTrainer:
    def __init__(self):
        self.samples = {"white": [], "red": [], "orange": [], "green": [], "blue": [], "yellow": []}
        self.color_map = {
            "1": "white",
            "2": "red",
            "3": "orange",
    ...
    def draw_interface(self, frame):
        ...
        for i, text in enumerate(instructions):
            cv2.putText(
                frame, text, (20, 60 + i * 20), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (200, 200, 200), 1
            )
        ...
        for i, (color, count) in enumerate(counts.items()):
            ...
            cv2.rectangle(
                frame,
                (x + 20, y - 12),
                (x + 20 + int(bar_width * progress), y - 3),
                (0, 255, 0) if progress >= 1.0 else (0, 255, 255),
                -1,
            )
    ...
    def save_samples(self):
        ...
        for color, samples in self.samples.items():
            ...
            status = (
                ...
                else f"⚠️  Need {self.target_samples - count} more"
            )
        ...
        while True:
            ...
            if current_color:
                ...
                cv2.putText(
                    ...
                    cv2.FONT_HERSHEY_SIMPLEX,
                    0.6,
                    self.get_color_bgr(current_color),
                    2,
                )
